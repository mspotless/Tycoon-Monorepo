...
export default function OfflinePage() {
  return (
    <main
      className="flex min-h-screen items-center justify-center bg-[#010F10] px-6 py-16 text-[#F0F7F7]"
      aria-labelledby="offline-page-title"
    >
      <div className="w-full max-w-xl rounded-[2rem] border border-[#00F0FF]/20 bg-[#07181B] p-8 shadow-[0_25px_60px_rgba(0,0,0,0.35)]">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#00F0FF]/10 text-[#00F0FF]">
          <WifiOff className="h-7 w-7" />
        </div>
        <h1
          id="offline-page-title"
          className="mt-6 font-orbitron text-3xl font-bold uppercase tracking-[0.12em]"
        >
          Offline Shell
        </h1>
        <p
          className="mt-4 text-sm leading-6 text-[#F0F7F7]/75 sm:text-base"
          id="offline-page-description"
        >
